...
cores = min(2,multiprocessing.cpu_count())
...
def feets_parallel(i, times, mags, koi_n, save_f):
...
name_saved_file = "Feets_Features/ResumenFeets_sinError.csv"
